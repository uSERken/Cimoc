...
public interface Parser {
     ...
     * 惰性加载的情况，一次性不能拿到所有图片链接，例如网站使用了多次异步请求 {@link A2DM5#parseImages}，或需要跳转到不同页面
     * 才能获取 {@link A3HHSSEE#parseImages}，这些情况一般可以根据页码构造出相应的请求链接，到阅读时再解析
     * 支持多个链接 {@link ImageUrl#urls}，例如 {@link A4IKanman#parseImages}
     * @param html 页面源代码
     */
