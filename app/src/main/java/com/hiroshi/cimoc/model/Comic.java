...
public class Comic {
    ...
    public Comic(int source, String cid, String title, String cover, String update, String author,String updateTo) {
        this(null, source, cid, title, cover == null ? "" : cover, false, false, update,
                null, null, null, null, null, null, null,updateTo);
        this.author = author;
    }
    ...
    public Comic(Long id, int source, @NotNull String cid, @NotNull String title, @NotNull String cover, boolean highlight,
            ...
            String chapter, String updateTo) {
        this.id = id;
        this.source = source;
        this.cid = cid;
        this.title = title;
